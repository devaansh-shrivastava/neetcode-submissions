class Solution {
    ...
    public boolean binary(int[][] arr, int t, int l, int h) {
        ...
        if(t == arr[r][c]) { System.out.println(m + " 1"); return true; }
        else if (t < arr[r][c]) { System.out.println(m + " 2"); return binary(arr, t, l, m-1); }
        else { System.out.println(m + " 3"); return binary(arr, t, m+1, h); }
    }
}
